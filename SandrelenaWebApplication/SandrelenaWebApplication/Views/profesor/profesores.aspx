<%@ Page Title="" Language="C#" MasterPageFile="~/siteTeacher.Master" AutoEventWireup="true" CodeBehind="profesores.aspx.cs" Inherits="SandrelenaWebApplication.Views.profesor.profesores" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="container">
                    <div class="row">
                            <div class="col-md-5">
                                <h1 class="sandrelena-heading">Clases que imparte</h1>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <asp:DropDownList ID="ddlClases" runat="server" CssClass="customSelect"  AutoPostBack="true">
                                    </asp:DropDownList>
                  ...
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="grade">
                        <div class="row">
                             <div class="col-md-5">
                                 <h1 class="sandrelena-sub-heading"><small>Registro de notas</small></h1>
                             </div>
                         </div>

                        <div class="row">
                            <div class="col-md-12">
                                <asp:GridView runat="server" ID="notas"> 
    ...
    <script src="../../Scripts/profesores.js" type="text/javascript"></script>
